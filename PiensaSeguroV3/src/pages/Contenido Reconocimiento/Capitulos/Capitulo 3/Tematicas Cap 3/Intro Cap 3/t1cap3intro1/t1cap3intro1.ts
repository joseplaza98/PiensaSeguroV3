...
/**
 * Generated class for the T1cap3intro1Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-t1cap3intro1',
  templateUrl: 't1cap3intro1.html',
})
export class T1cap3intro1Page {


  intro: string = "explorar";
