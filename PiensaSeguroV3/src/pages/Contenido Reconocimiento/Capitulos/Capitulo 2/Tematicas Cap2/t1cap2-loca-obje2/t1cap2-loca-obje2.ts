...
/**
 * Generated class for the T1cap2LocaObje2Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-t1cap2-loca-obje2',
  templateUrl: 't1cap2-loca-obje2.html',
})
export class T1cap2LocaObje2Page {

  intro: string = "barridos";
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad T1cap2LocaObje2Page');
  }
