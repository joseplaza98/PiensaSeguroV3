...
/**
 * Generated class for the T1cap2LocaObje1Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-t1cap2-loca-obje1',
  templateUrl: 't1cap2-loca-obje1.html',
})
export class T1cap2LocaObje1Page {

  intro: string = "basedatos";
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad T1cap2LocaObje1Page');
  }
}
